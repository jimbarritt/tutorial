...
public class QuantityConverterTest {
    ...
    public void fails_if_try_to_convert_incompatible_units() {
        new Unit.QuantityConverter(20, Unit.centimetres).to(metres);
    }

    @Test
    public void converts_from_metres_to_centimetres() {
        Quantity convertedQuantity = new Unit.QuantityConverter(0.1, metres).to(centimetres);
    ...
    public void converts_from_litres_to_millilitres() {
        Quantity convertedQuantity = new Unit.QuantityConverter(0.01, litres).to(millilitres);
